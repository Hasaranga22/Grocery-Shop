...
<section class="wishlist">
   ...
   <form action="" method="POST" class="box">
      ...
      <input type="number" min="1" value="1" class="qty" name="p_qty" style="text-align: center;width: 80px;border:1px solid black">
   ...
   <?php
      ...
      echo '<p class="empty" style="text-align:center;font-size:15px">your wishlist is empty</p>';
   }
   ?>
   </div>
